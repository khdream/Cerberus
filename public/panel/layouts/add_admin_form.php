    ...
    <div class="sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <?php endif; ?>
                <form action="op.php?o=add_admin" method="post">
            ...
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Yeni Admin Ekle</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        Bu alandan ekleyeceğiniz yönetici bu panele tam erişim yetkisine sahip olacaktır.
                    </p>
                </div>
            </div>
        </div>
