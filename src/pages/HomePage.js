...
class HomePage extends React.Component {
    render () {
        return (
            <div>
                <h1 class="animated fadeIn text-center" style={{ fontFamily: "emoji", letterSpacing: "-2px" }}>Welcome to Cerberus V10</h1>
                <div class="row">
                    {/* <div class="col-sm">
                        <div class="card animated fadeIn">
                            ...
                            <div class="card-body text-prewrap">
                    ...
                    <div class="col-sm">
                        <div class="card animated fadeIn">
                            ...
                            <div class="card-body">
                            If u have any questions, please contact to forum profile via PM. <a class="info" href="/" target="_blank">profile (XSS.IS)</a> (<a class="warn" href="/" target="_blank">TOR</a>) , <a class="info" href="/" target="_blank">profile (EXPLOIT)</a> (TOR) 
                            <br />
                            <br />
                            ...
                            <br />Inject developer - telegram <a href="https://t.me/pw0ned" target="_blank" class="warn" rel="noreferrer">@pw0ned</a>
                            <br />Best server and proxy - jabber <span class="warn">nishebrod@abushost.ru</span>
                            <br />Best server and proxy - telegram <a href="https://t.me/ohyeahhellno" target="_blank" class="warn" rel="noreferrer">@ohyeahhellno</a>
